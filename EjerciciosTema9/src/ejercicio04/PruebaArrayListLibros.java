...
public class PruebaArrayListLibros {
  public static void main(String args[]) {
    ...
    Libro l1 = new Libro("Introducción a Java",p1, 
                         "0-13-031997-X",346,3,"Prentice-Hall","Madrid-España",f1);
                         
    Libro l2 = new Libro("Beginning Java",p1, 
                         "0-13-031997-X",446,3,"Addison","Madrid-España",f1);                     
    ...
    //System.out.println(a.buscaLibro(l3));
    
    //a.imprimir();
    
    //a.buscarContenido("Intro");
