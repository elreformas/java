...
public class LinkedListProducto {
	...
	private LinkedList<productoLinked> inventario;
	
	public LinkedListProducto() {
		
		inventario = new LinkedList<productoLinked>();
		
	}
	
	
	public boolean agregarProducto(productoLinked p) {
	...
	public void imprimirLista(LinkedListProducto n) {
